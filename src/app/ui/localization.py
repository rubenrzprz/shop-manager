...
_TRANSLATIONS = {
    "es": {
        ...
        "Orders Due Soon": "Pedidos próximos",
        "Recent Orders": "Pedidos recientes",
        "No orders due soon.": "No hay pedidos próximos.",
        "No recent orders.": "No hay pedidos recientes.",
        ...
        "Created": "Creado",
        "Updated": "Actualizado",
        "{prefix} today": "{prefix} hoy",
        "{prefix} yesterday": "{prefix} ayer",
        "{prefix} {count} days ago": "{prefix} hace {count} días",
        ...
        "No pending tasks for selected date.": (
            "No hay tareas pendientes para la fecha seleccionada."
        ),
        "No completed tasks for selected date.": (
            "No hay tareas completadas para la fecha seleccionada."
        ),
        ...
        "Could not load calendar": "No se pudo cargar el calendario",
        "January": "Enero",
        "February": "Febrero",
        "March": "Marzo",
        "April": "Abril",
